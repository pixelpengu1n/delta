...
retrieved_data = [
    {
        ...
        "time_object": {"timestamp": "2025-03-10T12:34:56Z", "timezone": "GMT+11"},
        "events": [
            {
                "time_object": {
...
if preprocess_response.status_code == 200:
    ...
    if analyse_response.status_code == 200:
        ...
        print(
            f"Error during analysis: {analyse_response.status_code}, {analyse_response.text}"
        )
else:
    print(
        f"Error during preprocessing: {preprocess_response.status_code}, {preprocess_response.text}"
    )
